...
<base href="<%=basePath%>">
  <head>
   ...
   <link rel="stylesheet" type="text/css" href="<%=basePath%>/css/purchase.base.2012.css" />
   <link rel="stylesheet" type="text/css" href="<%=basePath%>/css/purchase.sop.css" />
   ...
   <script type="text/javascript" src="<%=basePath%>/js/taotao.js" charset="utf-8"></script>
</head> <body id="mainframe">
<!--shortcut start-->
<jsp:include page="commons/shortcut.jsp" />
<!--shortcut end-->
<div class="w" id="headers">
		<div id="logo"><a href="/"><img alt="淘淘商城" src="<%=basePath%>/images/taotao-logo.gif"></a></div>
