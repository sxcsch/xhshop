        ...
        <div id="show">
            ...
            <div class="cart-inner">
                <div class="cart-thead clearfix">
                    ...
                    <div class="column t-num">编号</div>
                    <div class="column t-goods">商品</div>
                    <div class="column t-price">鲜花价</div>
                ...
                <div id="product-list" class="cart-tbody">
                    ...
                    <c:forEach items="${list}" var="cart">
                        <c:set var="totalPrice"  value="${ totalPrice + (cart.price * cart.amount)}"/>
                            ...
                            <div class="item_form clearfix">
                                ...
                                <div class="cell p-quantity" for-stock="for-stock-11345721">
                                    <div class="quantity-form" data-bind="">
                                        ...
                                        <input type="text" class="quantity-text" itemPrice="${cart.price}" itemId="${cart.id}" value="${cart.amount }" id="changeQuantity-11345721-1-1-0">
